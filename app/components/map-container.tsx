...
interface MapContainerProps {
  ...
  onPanoMarkerClick: (data: any) => void; // Add this prop
}
...
export default function MapContainer({
  ...
  onDrawLoad,
  onAnnotationStart,
  onPanoMarkerClick, // Add this destructured prop
}: MapContainerProps) {
  return (
    <div className="relative flex h-full w-full items-center justify-center bg-background">
      <MapComponent
        ...
        onPanoMarkerClick={onPanoMarkerClick} // Pass the prop to MapComponent
      />
      <MapControls
        activeTool={activeTool}
        onToolChange={onToolChange}
